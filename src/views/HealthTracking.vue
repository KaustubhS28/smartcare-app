  ...
  <div class="health-tracking-page">
    ...
    <div class="goals-section">
      ...
      <div class="goals-grid">
        <div v-for="goal in healthGoals" :key="goal.id" class="goal-card">
          <div class="goal-header">
            <div class="goal-icon" :class="goal.category.toLowerCase()">
            ...
            <div class="goal-status" :class="goal.status.toLowerCase()">
              {{ goal.status }}
            </div>
          </div>
          ...
          <div class="goal-timeline">
            <span class="timeline-start">{{ new Date(goal.startDate).toLocaleDateString() }}</span>
            <span class="timeline-end">{{ new Date(goal.endDate).toLocaleDateString() }}</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="activity-chart">
          <div class="chart-placeholder">
            <svg width="100%" height="200" viewBox="0 0 400 200">
              ...
              <circle cx="350" cy="70" r="3" fill="#3b82f6"/>
            </svg>
          </div>
