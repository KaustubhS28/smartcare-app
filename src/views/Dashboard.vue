...
const { stepsData, sleepData, summary, loading, error, fetchDashboardData } = useHealthApi()
...
const chartOptions = {
  ...
  plugins: {
    legend: { position: 'top' },
    title: { display: true, text: 'Weekly Health Trends' },
  },
}
  ...
  <div class="dashboard">
    ...
    <div class="dashboard-grid">
      ...
      <div class="dashboard-analytics">
        ...
        <div class="charts">
          <HealthChart :type="'line'" :chartData="stepsData" :options="chartOptions" v-if="stepsData" />
          <HealthChart :type="'bar'" :chartData="sleepData" :options="chartOptions" v-if="sleepData" />
        </div>
      </div>
    </div>
  </div>
